insert into responsables (primer_nombre_responsable,segundo_nombre_responsable,primer_apellido_responsable,segundo_apellido_responsable,dpi_responsable,fecha_nacimiento_responsable,edad_responsable,sexo_responsable,direccion_responsable,telefono_responsable,email_responsable)values('luis','enrique','Estrada','Yoc',12131321,'2021/05/21',30,'masculino','huehuetenango','78562345','yo@gmail.com')
...
insert into contenidos (nombre_contenido,fecha_creacion,archivo,clase_id) values('contenido seman 1','2021/10/20','pruebaArchivo',1)